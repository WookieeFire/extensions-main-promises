...
const SOURCE_DOMAIN = "https://mangafire.to/home"
...
export class MangaFire extends Source {
    ...
    get name(): string { return 'MangaFire' }
    get description(): string { return 'mangafire.to is the source' }
    get author(): string { return 'Krollos' }
